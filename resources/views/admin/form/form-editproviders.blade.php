			...
			<div class="row">
				<div class="col-sm-12">
					...
					<div class="input-group mb-3">
						...
						<textarea class="form-control" name="nit" rows="1" id="unit" style="resize: none"></textarea>
					</div>
					<div class="input-group mb-3">
						<div class="input-group-prepend">
						    <span class="input-group-text" id="basic-addon1">Nombre Empresa</span>
						</div>
						<textarea class="form-control" name="business_name" rows="1" id="ubusiness_name" style="resize: none"></textarea>
					</div> 
					<div class="input-group mb-3">
						<div class="input-group-prepend">
						    <span class="input-group-text" id="basic-addon1">Descripción de la empresa</span>
						</div>
						<textarea class="form-control" name="description" rows="1" id="udescription" style="resize: none"></textarea>
					</div> 
				</div>
				<div class="col-sm-6">
					<div class="input-group mb-3">
						...
						<textarea class="form-control" name="country" rows="1" id="ucountry" style="resize: none"></textarea>
					</div>
					<div class="input-group mb-3">
						<div class="input-group-prepend">
				...
				<div class="col-sm-6">
					<div class="input-group mb-3">
						...
						<textarea class="form-control" name="phone1"  rows="1" id="uphone1" style="resize: none"></textarea>
					</div> 	
					<div class="input-group mb-3">
						<div class="input-group-prepend">
						    <span class="input-group-text" id="basic-addon1">Fijo 2</span>
						</div>
						<textarea class="form-control" name="phone2" rows="1" id="uphone2" style="resize: none"></textarea>
					</div> 
				</div>
				<div class="col-sm-6">
					<div class="input-group mb-3">
						...
						<textarea class="form-control" name="cellphone1" rows="1" id="ucellphone1" style="resize: none"></textarea>
					</div> 
					<div class="input-group mb-3">
						<div class="input-group-prepend">
						    <span class="input-group-text" id="basic-addon1">Celular 2</span>
						</div>
						<textarea class="form-control" name="cellphone2" rows="1" id="ucellphone2" style="resize: none"></textarea>
					</div> 
				</div>
			</div>
		</div>
