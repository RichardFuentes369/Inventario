			...
			<div class="row">
				<div class="col-sm-12">
					...
					<div class="input-group mb-3">
						...
						<textarea class="form-control inputcenter" rows="1" id="sdescription" style="resize: none" readonly></textarea>
					</div> 
				</div>
				<div class="col-sm-6">
					<div class="input-group mb-3">
				...
				<div class="col-sm-6">
					...
					<div class="input-group mb-3">
						...
						<textarea class="form-control inputcenter" rows="1" id="sphone2" style="resize: none" readonly></textarea>
					</div> 
				</div>
				<div class="col-sm-6">
					<div class="input-group mb-3">
					...
					<div class="input-group mb-3">
						...
						<textarea class="form-control inputcenter" rows="1" id="scellphone2" style="resize: none" readonly></textarea>
					</div> 
				</div>
			</div>
		</div>
