...
class ProductsController extends Controller
{
    ...
    public function updateProduct(Request $request){
        ...
        if($provider_id == ""){
            $actualizar = DB::UPDATE('UPDATE products set name = :varname, lote = :varlote, manufacturing_date = :varmanufacturing_date, expiration_date = :varexpiration_date, quantity = :varquantity WHERE id = :varid',['varname' => $name, 'varlote' => $lote, 'varmanufacturing_date' => $manufacturing_date, 'varexpiration_date' => $expiration_date, 'varquantity' => $quantity, 'varid' => $id]);
            Flash::warning("Se ha actualizado el producto con id: " .$id);
        }else{
            $actualizar = DB::UPDATE('UPDATE products set name = :varname, lote = :varlote, manufacturing_date = :varmanufacturing_date, expiration_date = :varexpiration_date, quantity = :varquantity, provider_id = :varprovider_id WHERE id = :varid',['varname' => $name, 'varlote' => $lote, 'varmanufacturing_date' => $manufacturing_date, 'varexpiration_date' => $expiration_date, 'varquantity' => $quantity, 'varprovider_id' => $provider_id, 'varid' => $id]);
            Flash::warning("Se ha actualizado el producto con id: " .$id);
        }
        return back();
    }
